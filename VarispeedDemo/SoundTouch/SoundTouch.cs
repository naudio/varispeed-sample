...
namespace VarispeedDemo.SoundTouch
{
    class SoundTouch : IDisposable
    {
        ...
        public bool IsEmpty
        {
            get { return SoundTouchInterop64.soundtouch_isEmpty(handle) != 0; }
        }

        public int NumberOfSamplesAvailable
        {
            get { return (int)SoundTouchInterop64.soundtouch_numSamples(handle); }
        }

        public int NumberOfUnprocessedSamples
        {
            get { return SoundTouchInterop64.soundtouch_numUnprocessedSamples(handle); }
        }
